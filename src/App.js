...
function choose_word_bt(disable, setDisable, setWord, setShowWord,setKeyClickedArray) {
...
export default function App() {
    ...
    function update_forca(word, show_word, letter) {
        if (!keyClickedArray.includes(letter)) {
            setShowWord(clickKey(letter, word, show_word, setDisable));
    ...
    return (
        <React.Fragment>
            <div className="up">
                ...
                <div className="right">
                    <button onClick={() => choose_word_bt(disable, setDisable, setWord, setShowWord,setKeyClickedArray)}>Escolher Palavra</button>
                    <span className={wordStyle()} >{word}  {show_word}</span>
                </div>
            </div>
                ...
                <div className="keyboard">
                    <div>
                        {alphabet.map((letter, index) =>
                            <div className={`${disable ? "disable" : ""}  ${keyClickedArray.includes(letter) ? "clicked" : ""}`} key={index} onClick={() => !disable ? update_forca(word, show_word, letter) : ""}>
